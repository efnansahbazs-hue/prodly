...
const artistAvatars: AvatarPreset[] = [
  {
    id: "dj-hooded",
    label: "DJ",
    render: s("linear-gradient(135deg, #1a0a2e, #2d1b69)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <ellipse cx="24" cy="16" rx="10" ry="11" fill="#0d0520" />
        <path d="M14 14 Q14 8 24 6 Q34 8 34 14" fill="none" stroke="#2d1b69" strokeWidth="2" />
        <rect x="12" y="12" width="4" height="6" rx="2" fill="#7C3AED" />
        <rect x="32" y="12" width="4" height="6" rx="2" fill="#7C3AED" />
        <path d="M12 15 Q12 10 24 8 Q36 10 36 15" fill="none" stroke="#7C3AED" strokeWidth="1.5" />
        <circle cx="20" cy="17" r="1.5" fill="#A78BFA" opacity="0.9" />
        <circle cx="28" cy="17" r="1.5" fill="#A78BFA" opacity="0.9" />
        <path d="M14 30 Q24 36 34 30" fill="#0d0520" />
      </svg>
    )),
  },
  {
    id: "producer",
    label: "Producer",
    render: s("linear-gradient(135deg, #1a1a2e, #16213e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <ellipse cx="26" cy="20" rx="9" ry="10" fill="#1a1a2e" stroke="#334" strokeWidth="0.5" />
        <rect x="18" y="16" width="16" height="5" rx="2.5" fill="none" stroke="#7C3AED" strokeWidth="1" opacity="0.6" />
        <rect x="19" y="17" width="6" height="3" rx="1" fill="rgba(124,58,237,0.3)" />
        <rect x="27" y="17" width="6" height="3" rx="1" fill="rgba(124,58,237,0.3)" />
        <circle cx="22" cy="18.5" r="0.8" fill="#A78BFA" />
        <circle cx="30" cy="18.5" r="0.8" fill="#A78BFA" />
  ...
  },
  {
    ...
    render: s("linear-gradient(135deg, #1a0a3e, #2d1b69)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <path d="M16 12 L24 8 L32 12 L32 28 Q24 34 16 28Z" fill="#0d0520" stroke="#7C3AED" strokeWidth="0.5" opacity="0.5" />
        <circle cx="24" cy="22" r="5" fill="none" stroke="#A78BFA" strokeWidth="1" opacity="0.7" />
        <circle cx="24" cy="22" r="3" fill="rgba(124,58,237,0.3)" />
        <path d="M21 22 Q22 20 24 22 Q26 20 27 22" fill="none" stroke="#6EE7B7" strokeWidth="0.5" />
        <circle cx="24" cy="22" r="1" fill="#A78BFA" opacity="0.9" />
      </svg>
    )),
  },
  {
    ...
    render: s("linear-gradient(135deg, #1a0a2e, #2d1b69)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <path d="M24 10 L20 20 L26 20 L22 32" fill="none" stroke="#A78BFA" strokeWidth="2" strokeLinecap="round" />
        <path d="M18 16 L24 10 L30 16" fill="none" stroke="#7C3AED" strokeWidth="1" opacity="0.6" />
        <circle cx="21" cy="18" r="1" fill="#A78BFA" />
        <circle cx="27" cy="18" r="1" fill="#A78BFA" />
        <line x1="20" y1="24" x2="28" y2="24" stroke="#7C3AED" strokeWidth="0.5" opacity="0.4" />
      </svg>
    )),
  },
];
...
const characterAvatars: AvatarPreset[] = [
  {
    id: "wolf",
    label: "Wolf",
    render: s("linear-gradient(135deg, #1a1a2e, #2d2d44)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        ...
        <ellipse cx="24" cy="25" rx="2" ry="1" fill="#1a1a2e" />
      </svg>
    )),
  },
  {
    ...
    render: s("linear-gradient(135deg, #1a1a2e, #16213e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <rect x="16" y="12" width="16" height="18" rx="4" fill="#16213e" stroke="#7C3AED" strokeWidth="1" />
        <rect x="14" y="16" width="3" height="2" rx="1" fill="#7C3AED" opacity="0.5" />
        <rect x="31" y="16" width="3" height="2" rx="1" fill="#7C3AED" opacity="0.5" />
        <circle cx="21" cy="19" r="2" fill="#34D399" opacity="0.8" />
        <circle cx="27" cy="19" r="2" fill="#34D399" opacity="0.8" />
        <rect x="20" y="24" width="8" height="3" rx="1" fill="#1a1a2e" stroke="#555" strokeWidth="0.5" />
  ...
  },
  {
    ...
    render: s("linear-gradient(135deg, #2e1a0a, #4a2f1a)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        ...
        <circle cx="20" cy="20" r="1.5" fill="#0d0520" />
        <circle cx="20" cy="20" r="0.7" fill="#A78BFA" />
        <circle cx="28" cy="20" r="1.5" fill="#0d0520" />
        <circle cx="28" cy="20" r="0.7" fill="#A78BFA" />
  ...
  },
  {
    id: "the-eye",
    label: "The Eye",
    render: s("linear-gradient(135deg, #0a0a1f, #1a0a2e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <ellipse cx="24" cy="22" rx="12" ry="7" fill="none" stroke="#7C3AED" strokeWidth="1.5" />
        <circle cx="24" cy="22" r="5" fill="#1a0a2e" stroke="#A78BFA" strokeWidth="1" />
        <circle cx="24" cy="22" r="2.5" fill="#7C3AED" />
        <circle cx="24" cy="22" r="1" fill="#fff" opacity="0.8" />
        {[-3,-2,-1,0,1,2,3].map(i => (
          <line key={i} x1={24 + i * 2} y1={14 + Math.abs(i)} x2={24 + i * 2} y2={12 + Math.abs(i)} stroke="#A78BFA" strokeWidth="0.5" opacity={0.3 + Math.abs(i) * 0.1} />
        ))}
      </svg>
    )),
  },
  {
    ...
    render: s("linear-gradient(135deg, #0a0a2e, #1a1a3e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        ...
        <circle cx="20" cy="19" r="3" fill="#0a0a2e" stroke="#A78BFA" strokeWidth="0.5" />
        <circle cx="28" cy="19" r="3" fill="#0a0a2e" stroke="#A78BFA" strokeWidth="0.5" />
  ...
  },
  {
    id: "octopus",
    label: "Octopus",
    render: s("linear-gradient(135deg, #1a0a2e, #2e1a4a)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <ellipse cx="24" cy="18" rx="8" ry="7" fill="#2e1a4a" stroke="#7C3AED" strokeWidth="0.5" />
        <circle cx="21" cy="16" r="1.5" fill="#A78BFA" />
        <circle cx="27" cy="16" r="1.5" fill="#A78BFA" />
        {[0,1,2,3].map(i => (
          <React.Fragment key={i}>
            <path d={`M${16 + i * 4} 24 Q${14 + i * 4} 32 ${12 + i * 5} 30`} fill="none" stroke="#7C3AED" strokeWidth="1.5" strokeLinecap="round" opacity={0.6} />
...
const abstractAvatars: AvatarPreset[] = [
  {
    ...
    render: s("linear-gradient(135deg, #0a0a1f, #1a0a2e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <polygon points="24,10 34,28 14,28" fill="none" stroke="#7C3AED" strokeWidth="1.5" />
        <polygon points="24,14 30,25 18,25" fill="rgba(124,58,237,0.2)" />
        <line x1="24" y1="28" x2="20" y2="34" stroke="#A78BFA" strokeWidth="1" opacity="0.5" />
        <line x1="24" y1="28" x2="24" y2="35" stroke="#7C3AED" strokeWidth="1" opacity="0.5" />
      ...
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        {[[24,16],[20,20],[28,20],[20,26],[28,26],[24,30]].map(([cx,cy], i) => (
          <polygon key={i}
            ...
            fill={i < 3 ? "rgba(124,58,237,0.3)" : "rgba(52,211,153,0.2)"}
            stroke={i < 3 ? "#7C3AED" : "#34D399"} strokeWidth="0.5" />
        ))}
      </svg>
    )),
  },
  {
    ...
    render: s("#050508", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        <circle cx="24" cy="22" r="10" fill="#050508" />
        <circle cx="24" cy="22" r="10" fill="none" stroke="#7C3AED" strokeWidth="2" opacity="0.6" />
        <circle cx="24" cy="22" r="12" fill="none" stroke="#7C3AED" strokeWidth="0.5" opacity="0.2" />
        <circle cx="24" cy="22" r="8" fill="none" stroke="#A78BFA" strokeWidth="0.5" opacity="0.3" />
      </svg>
    )),
  },
  {
        ...
        {[0,30,60,90,120,150,180,210,240,270,300,330].map((deg, i) => {
          ...
          return (
            <line key={deg} x1="24" y1="22" x2={24 + Math.cos(rad) * len} y2={22 + Math.sin(rad) * len}
              stroke={i % 2 === 0 ? "#7C3AED" : "#34D399"} strokeWidth="1.5" strokeLinecap="round" opacity={0.6} />
          );
        })}
  ...
  },
  {
    ...
    render: s("linear-gradient(135deg, #0a0a1f, #1a0a2e)", (
      <svg viewBox="0 0 48 48" width="100%" height="100%">
        ...
        <circle cx="19" cy="20" r="1" fill="#A78BFA" />
