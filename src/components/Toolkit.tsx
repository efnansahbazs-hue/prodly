    ...
    <section className="relative py-24 md:py-32 px-5">
      <div className="max-w-5xl mx-auto">
        <ScrollReveal>
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center text-white mb-10 whitespace-nowrap" style={{ fontFamily: "'Space Grotesk'", fontSize: "clamp(26px, 4vw, 52px)" }}>
            {t("tk.title")}
          </h2>
        </ScrollReveal>
